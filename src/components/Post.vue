<template>
  <article :id="id" class="article">
    ...
    <transition mode="out-in" enter-active-class="post-slide-enter" leave-active-class="post-slide-leave">
...
.post-slide-enter {
  animation: slideInDown 0.25s linear forwards;
}

.post-slide-leave {
  animation: slideOutUp 0.25s linear forwards;
}
